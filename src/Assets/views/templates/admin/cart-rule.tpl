...
<script type="text/javascript">
	...
	var currentText = '{l s='Now' mod='[[MODULENAME]]' js=1}';
	var closeText = '{l s='Done' mod='[[MODULENAME]]' js=1}';
	var timeOnlyTitle = '{l s='Choose Time' mod='[[MODULENAME]]' js=1}';
	var timeText = '{l s='Time' mod='[[MODULENAME]]' js=1}';
	var hourText = '{l s='Hour' mod='[[MODULENAME]]' js=1}';
	var minuteText = '{l s='Minute' mod='[[MODULENAME]]' js=1}';
...
<div id="cart_rule_toggler">
    <div class="panel">
        <h3><i class="icon-random"></i> {l s='Conditions' mod='[[MODULENAME]]'}</h3>
        <div class="form-group">
        	<label class="control-label col-lg-3">
        		<span class="label-tooltip" data-toggle="tooltip" title="{l s='The default period is one month.' mod='[[MODULENAME]]'}">
        			{l s='Valid' mod='[[MODULENAME]]'}
        		</span>
        	</label>
        	<div class="col-lg-9">
        		<div class="row">
        			<div class="col-lg-6">
        				<div class="input-group">
        					...
        					<span class="input-group-addon">{l s='days' mod='[[MODULENAME]]'}</span>
        				</div>
        			</div>
        		</div>
        	</div>
        ...
        <div class="form-group">
        	<label class="control-label col-lg-3">
        		<span class="label-tooltip" data-toggle="tooltip" title="{l s='You can choose a minimum amount for the cart either with or without the taxes and shipping.' mod='[[MODULENAME]]'}">
        			{l s='Minimum amount' mod='[[MODULENAME]]'}
        		</span>
        	</label>
        	<div class="col-lg-9">
        		<div class="row">
        			...
        			<div class="col-lg-3">
        				<select name="minimum_amount_tax">
        					<option value="0" {if $currentTab->getFieldValue($currentObject, 'minimum_amount_tax') == 0}selected="selected"{/if}>{l s='Tax excluded' mod='[[MODULENAME]]'}</option>
        					<option value="1" {if $currentTab->getFieldValue($currentObject, 'minimum_amount_tax') == 1}selected="selected"{/if}>{l s='Tax included' mod='[[MODULENAME]]'}</option>
        				</select>
        			</div>
        			<div class="col-lg-4">
        				<select name="minimum_amount_shipping">
        					<option value="0" {if $currentTab->getFieldValue($currentObject, 'minimum_amount_shipping') == 0}selected="selected"{/if}>{l s='Shipping excluded' mod='[[MODULENAME]]'}</option>
        					<option value="1" {if $currentTab->getFieldValue($currentObject, 'minimum_amount_shipping') == 1}selected="selected"{/if}>{l s='Shipping included' mod='[[MODULENAME]]'}</option>
        				</select>
        			</div>
        		</div>
        	</div>
        ...
        <p class="checkbox col-lg-offset-3">
				<label>
					...
					{l s='Compatibility with other cart rules' mod='[[MODULENAME]]'}
				</label>
			</p>
    </div>

    <div class="panel">
        <h3><i class="icon-wrench"></i> {l s='Actions' mod='[[MODULENAME]]'}</h3>
        <div class="form-group">
        	<label class="control-label  col-lg-3">{l s='Free shipping' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-9">
        ...
        <div class="form-group">
        	<label class="control-label col-lg-3">{l s='Apply a discount' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-9">
        		<div class="radio">
        		...
        		<div class="radio">
        			<label for="apply_discount_off">
        				...
        				<i class="icon-remove color_danger"></i> {l s='None' mod='[[MODULENAME]]'}
        			</label>
        		</div>
        	</div>
        </div>
        ...
        <div id="apply_discount_percent_div" class="form-group">
        	<label class="control-label col-lg-3">{l s='Value' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-9">
        		...
        		<span class="help-block"><i class="icon-warning-sign"></i> {l s='Does not apply to the shipping costs' mod='[[MODULENAME]]'}</span>
        	</div>
        </div>

        <div id="apply_discount_amount_div" class="form-group">
        	<label class="control-label col-lg-3">{l s='Amount' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-7">
        		<div class="row">
        			<div class="col-lg-4">
        			...
        			<div class="col-lg-4">
        				<select name="reduction_tax" >
        					<option value="0" {if $currentTab->getFieldValue($currentObject, 'reduction_tax') == 0}selected="selected"{/if}>{l s='Tax excluded' mod='[[MODULENAME]]'}</option>
        					<option value="1" {if $currentTab->getFieldValue($currentObject, 'reduction_tax') == 1}selected="selected"{/if}>{l s='Tax included' mod='[[MODULENAME]]'}</option>
        				</select>
        			</div>
        		</div>
        	</div>
        ...
        <div id="apply_discount_to_div" class="form-group">
        	<label class="control-label col-lg-3">{l s='Apply a discount to' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-7">
        		<p class="radio">
        			<label for="apply_discount_to_order">
        				<input type="radio" name="apply_discount_to" id="apply_discount_to_order" value="order"{if $currentTab->getFieldValue($currentObject, 'reduction_product')|intval == 0} checked="checked"{/if} />
        				 {l s='Order (without shipping)' mod='[[MODULENAME]]'}
        			</label>
        		</p>
        		<p class="radio">
        			<label for="apply_discount_to_product">
        				...
        				{l s='Specific product' mod='[[MODULENAME]]'}
        			</label>
        		</p>
        		<p class="radio">
        			<label for="apply_discount_to_cheapest">
        				<input type="radio" name="apply_discount_to" id="apply_discount_to_cheapest" value="cheapest"{if $currentTab->getFieldValue($currentObject, 'reduction_product')|intval == -1} checked="checked"{/if} />
        				 {l s='Cheapest product' mod='[[MODULENAME]]'}
        			</label>
        		</p>
        	</div>
        </div>
        ...
        <div id="apply_discount_to_product_div" class="form-group">
        	<label class="control-label col-lg-3">{l s='Product' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-9">
        ...
        <div class="form-group">
        	<label class="control-label col-lg-3">{l s='Send a free gift' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-9">
        		<span class="switch prestashop-switch fixed-width-lg">
        ...
        <div id="free_gift_div" class="form-group">
        	<label class="control-label col-lg-3">{l s='Search a product' mod='[[MODULENAME]]'}</label>
        	<div class="col-lg-9">
        		<div class="input-group col-lg-5">
        ...
        <div id="gift_products_found" {if $gift_product_select == ''}style="display:none"{/if}>
        	<div id="gift_product_list" class="form-group">
        		<label class="control-label col-lg-3">{l s='Matching products' mod='[[MODULENAME]]'}</label>
        		<div class="col-lg-5">
        	...
        	<div id="gift_attributes_list" class="form-group">
        		<label class="control-label col-lg-3">{l s='Available combinations' mod='[[MODULENAME]]'}</label>
