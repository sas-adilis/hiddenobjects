...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'hiddenobjects_ea` (
...
$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'hiddenobjects_ea_founded` (
  ...
  KEY `id_hiddengifts` (`id_hiddenobject`),
  KEY `id_guest` (`id_guest`)
) ENGINE='._MYSQL_ENGINE_.' DEFAULT CHARSET=utf8;';

$sql[] = 'CREATE TABLE IF NOT EXISTS `'._DB_PREFIX_.'hiddenobjects_ea_lang` (
