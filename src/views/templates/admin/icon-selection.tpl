...
<div class="panel" id="icon_selection">
	<h3><i class="icon icon-info"></i> {l s='Choose your icon' mod='easterhiddenobjects'}</h3>
	<ul class="list-inline">
    	{foreach from=$icons item=icon}
    	    <li class="text-center">
    	        ...
    	        <br/>
    	        <span class="badge">{l s='Icon' mod='easterhiddenobjects'} #{$icon.id|intval}</span>
    	        <br/>
...
<p class="help-block">{l s='All icons avaibale above are under licence free for commercial use, views author\'s link in file licences.txt in folder %s/views/icons/' sprintf=$module_name mod='easterhiddenobjects'}</p>
<br/>
<br/>
{foreach from=$icons item=icon}
    {if $icon.selected}
